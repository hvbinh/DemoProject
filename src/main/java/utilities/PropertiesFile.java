...
public class PropertiesFile {
    ...
    private static String propertiesFilePathRoot = "config.properties";

    public static void setPropertiesFile() {
        properties = new Properties();
        try {
            //Khởi tạo giá trị cho đối tượng của class FileInputStream
            fileIn = new FileInputStream(GlobalConstants.ROOT_FOLDER + File.separator + propertiesFilePathRoot);
